import {  FormControl, FormErrorMessage, FormLabel,useMediaQuery, Stack, Input, Flex, Box, Text, Heading, useColorModeValue, SimpleGrid, useDisclosure,Button } from '@chakra-ui/react';
                        ...
                        <Stack>
                            <Flex align="center">
                                ...
                                <Input 
                                    ...
                                    ml="1.5" 
                                    type={"datetime-local"} 
                                    onChange={(e) => setBooking({...booking, StampIn: e.target.value}) }
                                />
                            </Flex>
                            <Flex align="center">
                                <HiOutlineCalendar size="22" />
                                <Input 
                                    ...
                                    ml="1.5" 
                                    type={"datetime-local"} 
                                    onChange={(e) => setBooking({...booking, StampOut: e.target.value}) }
                                />
                            </Flex>
