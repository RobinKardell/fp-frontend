...
import { Flex, Heading, Button, Box, useColorModeValue, Text, Stack, Center, Accordion, AccordionItem, AccordionButton, AccordionIcon, AccordionPanel, FormControl, FormLabel, Input, IconButton, useDisclosure, Card, Table, Thead, Th, Tbody, Tr, Td } from '@chakra-ui/react'
...
function Settings() {
    ...
    const { isOpen: addStuffIsOpen, onOpen: addStuffOnOpen, onClose: addStuffOnClose } = useDisclosure()
    ...
    return (
        <>
                        ...
                        >
                            ...
                            <Box>
                                ...
                                <Table>
                                    ...
                                    <Tbody>
                                        {articels && articels.map((articel, pi) => (
                                            <Tr>
                                                <Td>{articel.name}</Td>
            ...
            <AddArtikelForm getArticels={getArticels} isOpen={addArikelIsOpen} onOpen={addArikelOnOpen} onClose={addArikelOnClose} />
            <AddStuffForm getProducts={getProducts} isOpen={addStuffIsOpen} onOpen={addStuffOnOpen} onClose={addStuffOnClose} />
